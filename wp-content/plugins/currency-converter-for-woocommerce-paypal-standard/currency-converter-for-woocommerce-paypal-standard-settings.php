    ...
    public function get_settings() {
        ...
        $settings = apply_filters( 'woocommerce_general_settings', array(
            ...
            'currency_exchange_rate_service' => array(
                ...
                'desc'     => __( 'Choose which online currency exchange rate service will be used. *WARNING: currencylayer.com and xignite.com require API Access Keys to work. Using currencylayer.com is recommended. Other services may not support every possible currency.', 'currency-converter-for-woocommerce-paypal-standard. * WARNING: access key required' ),
                'desc_tip' =>  true,
